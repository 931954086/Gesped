...
(function ($) {
  ...
  function applyDarkModeSetting() {
    var $dark_mode_checkbox = $('#dark_mode_checkbox');

    if ($dark_mode_checkbox.length) {
      var isDarkMode = $('body').hasClass('dark-mode');
      $dark_mode_checkbox.prop('checked', isDarkMode);
      saveSettingToLocalStorage('DarkMode', isDarkMode);
    }
  }

  // Apply saved DarkMode setting on page load
