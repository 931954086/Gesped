...
setTimeout(function() {
  // Seletor jQuery para a div com o ID custom-feedback
  $('#custom-feedback').alert('close');
}, 10000); // 5000 milissegundos = 5 segundos

  // Adiciona um atraso de 5 segundos antes de esconder a mensagem
setTimeout(function() {
      // Seletor jQuery para encontrar o elemento com a classe alert-danger
      $('.alert-danger').fadeOut();
}, 10000); // 5000 milissegundos = 5 segundos


// Aguarde 10 segundos e, em seguida, remova a mensagem de erro
    setTimeout(function() {
