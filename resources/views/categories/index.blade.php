...
@section('title', 'Gesped | Lista de Categorias')
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="text-dark">Lista de Categorias</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('categories.create') }}">Criar</a></li>
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap" id="AllTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <form id="deleteForm_{{ $category->id }}" name="formModal"
                                        action="{{ route('categories.destroy', ['id' => $category->id]) }}"
                                        method="post" onsubmit="">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                            data-target="#modal-secondary_{{ $category->id }}">
                        ...
                        <div class="modal fade" id="modal-secondary_{{ $category->id }}">
                                ...
                                <div class="modal-content bg-secondary">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                        ...
                                        <button type="button" name="save" class="btn btn-outline-light"
                                            data-dismiss="modal"
                                            onclick="submitForm('deleteForm_{{ $category->id }}')">Salvar
                                            Alterações</button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
        ...
        <div class="modal-content bg-secondary">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" name="save" class="btn btn-outline-light" data-dismiss="modal"
                    onclick="submitForm('deleteForm_{{ $category->id }}')">Salvar Alterações</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
