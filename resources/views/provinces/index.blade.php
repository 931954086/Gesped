...
@section('title', 'Lista de Províncias')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('provinces.create') }}">Criar</a></li>
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap" id="AllTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right py-0 align-middle">
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('provinces.edit', ['id' => $province->id]) }}"
                                        class="btn btn-info" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <form id="deleteForm_{{ $province->id }}" name="formModal"
                                        action="{{ route('provinces.destroy', ['id' => $province->id]) }}"
                                        method="post" onsubmit="">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                            data-target="#modal-secondary_{{ $province->id }}">
                        ...
                        <div class="modal fade" id="modal-secondary_{{ $province->id }}">
                                ...
                                <div class="modal-content bg-secondary">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                        ...
                                        <button type="button" name="save" class="btn btn-outline-light"
                                            data-dismiss="modal"
                                            onclick="submitForm('deleteForm_{{ $province->id }}')">Salvar
                                            Alterações</button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
